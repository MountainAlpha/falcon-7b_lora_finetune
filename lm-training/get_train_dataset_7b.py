...
RATIO = 0.8
#------修改1--------------
EN_DATA_DIR = "/home/vot/votssd/code/ChenHu/HLLY/competition_kit/data/processed_data/06/processed_data_en.jsonl"
ZH_DATA_DIR = "/home/vot/votssd/code/ChenHu/HLLY/competition_kit/data/processed_data/09/processed_data_zh.jsonl"
#------修改2--------------
OUTPUT_FILES = "/home/vot/votssd/code/ChenHu/HLLY/competition_kit/data/processed_sampling_data/08/processed_data_sampling_en_zh.jsonl"
PROMPT_DICT = {
    "prompt_input": (
...
enc = AutoTokenizer.from_pretrained("/home/vot/votssd/code/ChenHu/HLLY/competition_kit/data/models/Baichuan2-7B-Base", use_fast=False, trust_remote_code=True)
